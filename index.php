...
<div id="hero">
	<div class="row">
		<div class="grid_12 heroImg" >			
			...
			<div class="heroTxt">
				<span><em>"We are great believers in teamwork,<br/>
				good working conditions, training for staff<br/>
				and giving everyone an opportunity<br/>
				to grow and develop"</em></span>
				<div></div>
				<img src="images/private-nhs.jpg" class="nhsprivateImg" alt="Private and NHS Dentist"/>
			</div>							
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="grid_4" >
		<div class="appointments" >
			<h2><span>to make an</span><br/>
			appointment<br/>
			<span>call</span><br/>
			<?php include('includes/telno.php') ?></h2>
		</div>
	</div>
</div>
